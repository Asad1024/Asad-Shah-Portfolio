...
const Data = ({darkMode}) => {
  ...
  return (
    <div className="home__data">
      ...
      I'm a passionate<span style={{ color: "#F7AB04" , fontSize:"1.1rem", margin: "0 5px", fontWeight:"bold" }}> Frontend</span> developer and designer, fully dedicated to my craft.
      </p>
      <a href="#contact" className="button button--flex">
       <span style={{ color:"#F7AB04"}}> Say</span> Hello
        <svg
